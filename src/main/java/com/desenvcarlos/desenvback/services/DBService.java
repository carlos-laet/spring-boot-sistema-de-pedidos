...
import com.desenvcarlos.desenvback.domain.PagamentoComBoleto;
import com.desenvcarlos.desenvback.domain.PagamentoComCartao;
import com.desenvcarlos.desenvback.domain.Pedido;
import com.desenvcarlos.desenvback.domain.Produto;
import com.desenvcarlos.desenvback.domain.enums.EstadoPagamento;
import com.desenvcarlos.desenvback.domain.enums.Perfil;
...
import com.desenvcarlos.desenvback.repositories.ClienteRepository;
import com.desenvcarlos.desenvback.repositories.EnderecoRepository;
import com.desenvcarlos.desenvback.repositories.EstadoRepository;
import com.desenvcarlos.desenvback.repositories.ItemPedidoRepository;
import com.desenvcarlos.desenvback.repositories.PagamentoRepository;
import com.desenvcarlos.desenvback.repositories.PedidoRepository;
import com.desenvcarlos.desenvback.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli2 = new Cliente(null, "Ana Costa", "anacosta@gmail.com", "31628382740", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("62733323", "39393838"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Ruas Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", "null", "Centro", "28177506", cli2, c2);
